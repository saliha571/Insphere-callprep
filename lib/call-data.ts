...
export interface RelatedWorkItem {
  ...
  thumbnailSrc?: string;
  /** White logo on dark raster → invert so it reads black on the light panel. */
  thumbnailInvert?: boolean;
}
...
export interface CallData {
  ...
  meetingNotes: {
    ...
    approachSections?: { label: string; text: string }[];
    // Drawer-only fields
...
export const CALLS: CallData[] = [
  {
    ...
    meetingNotes: {
      ...
      approachSections: [
        { label: "Open",   text: "Ask about the bottleneck, not Tkxel. Try: \"Walk me through what a typical acquisition cycle looks like for your team right now.\" Do not mention what we do until he has described the problem himself." },
        { label: "Middle", text: "Let him talk for the first half. Your job is to make him feel understood, not to demonstrate Tkxel. The moment he feels heard, he will ask what you can do — that is your signal to pivot." },
        { label: "Close",  text: "Ask for the scoping call directly. Do not wait for him to suggest next steps. Have two specific dates ready before you join. \"Based on what you've told me, I'd like to set up a 45-minute working session with you and Rachel — does Tuesday or Wednesday next week work?\"" },
        { label: "Avoid",  text: "Do not reference company size or revenue. Do not use the word platform. Do not start a sentence with \"Our product...\" Do not pitch in the first ten minutes under any circumstance." },
      ],
      callGoalOneSentence:
    ...
    relatedNews: {
      ...
      items: [
        {
          headline:
            "I saw you wrote about matching enterprise throughput without adding headcount, that framing resonated with us. Is that the lens you're applying to the due diligence side of the business too?",
          source: "LinkedIn",
          href: "#",
          context:
        ...
        {
          headline:
            "NewCo Risk put out something recently about the growing complexity of insurance exposure in mid-market PE deals. Is that something you're seeing accelerate on your end, more complexity per deal, or just more deals?",
          source: "LinkedIn",
          href: "#",
          context:
        ...
        {
          headline:
            "You mentioned boutique firms win on depth, not breadth. That's exactly how we think about building technology for firms like yours, deep fit for a specific workflow, not a broad platform you have to configure yourself.",
          source: "LinkedIn",
          href: "#",
          context:
        ...
        {
          headline:
            "What made you decide to go independent after Symphony Risk? I'm curious whether you were building toward something specific or whether the opportunity just presented itself.",
          source: "LinkedIn",
          href: "#",
          context:
    ...
    internalMatch: {
      ...
      reasoning: "Ali Hassan has delivered insurance document intelligence for a Lloyd's broker and understands PE due diligence at boutique scale. He is the strongest internal match for this call.",
      matchTags: ["Insurance", "PE Workflows", "Boutique Scale", "US Delivery"],
      contextNote: "No prior relationship with Andy — cold introduction. Recommend Hassan positions Ali as the technical expert on the scoping call, not as a vendor resource.",
      emailTo: "ali.hassan@tkxel.com",
      emailSubject: "Loop in — Andy Harbut, NewCo Risk, Discovery call today 3pm",
      emailBody: `Hey Ali,\n\nI have a discovery call today at 3pm with Andy Harbut, Co-Founder at NewCo Risk. They run insurance and risk exposure assessment for PE firms — 6-person boutique, fully manual due diligence process, 3 days per report.\n\nYour Lloyd's broker project from 2023 is the closest thing we have done to what they need. I want to propose bringing you in as technical lead on the scoping call next week.\n\nAny availability Tuesday or Wednesday afternoon? Will confirm timing once Andy agrees to the next step.`,
    },
    geoPresence: [
      {
        ...
        project: {
          title: "PE Advisory Workflow",
          tags: ["Insurance", "AI & Data", "Midwest", "2023"],
          problem: "A mid-market PE advisory firm was processing insurance documents manually across every acquisition cycle. Each report required two analysts and took three days to produce, creating bottlenecks during peak deal seasons.",
          whatWeBuilt: "An automated document ingestion pipeline that extracted structured data from insurance schedules and exposure reports, flagged anomalies automatically, and generated analyst-ready risk summaries.",
